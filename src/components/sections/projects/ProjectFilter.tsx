...
const ProjectFilter = ({ activeCategory, onCategoryChange, projectCount }: Props) => {
  const categories = [
    { 
     id: 'all', 
     label: 'All Projects', 
    ...
    <>
      ...
      <div className="text-center mb-8">
        <p className="font-body text-gray-600">
         <span className="font-medium text-black">{projectCount}</span> project{projectCount !== 1 ? 's' : ''}
          {activeCategory !== 'all' && (
