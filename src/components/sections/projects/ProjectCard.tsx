...
const ProjectCard = ({
  ...
  return (
    <article
      className={`relative flex-1 min-w-[280px] max-w-full sm:max-w-[calc(50%-0.5rem)] md:max-w-[calc(33%-0.5rem)] h-[340px] rounded-xl overflow-hidden bg-black shadow-xl group mobile-project-hover transition-all duration-500 will-change-transform ${
