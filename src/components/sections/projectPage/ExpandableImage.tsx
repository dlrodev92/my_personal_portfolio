...
const ExpandableImage = ({ src, alt, description, className, onClick }: ExpandableImageProps) => {
  return (
    <div className={`group relative overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all duration-500 cursor-pointer ${className || ''}`}>
      <img 
        src={src} 
        alt={alt}
